...
def explore_room(player_name):
    ...
    choice = input("What do you want to do? (north/east/inventory): ").lower()
    if choice == "north":
...
def explore_hallway(player_name):
    ...
    choice = input("What do you want to do? (up/west/inventory): ").lower()
    if choice == "up":
...
def explore_garden(player_name):
    ...
    choice = input("Do you want to get the key? (yes/no/inventory): ").lower()
    if choice == "yes":
...
def explore_second_floor(player_name):
    ...
    if "mysterious key" in inventory:
        choice = input("Do you want to use the mysterious key? (yes/no/inventory): ").lower()
        if choice == "yes":
...
def explore_library(player_name):
    ...
    choice = input("Do you want to read the book? (yes/no/inventory): ").lower()
    if choice == "yes":
